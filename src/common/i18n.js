...
const resources = {
  ...
  fr: {
    translation: {
      ...
      "Super Accélérée": "Super accéléré",
      "Details": "Détails",
      "Prix": "Prix",
      "name field is required": "Le champ nom est obligatoire",
      "description field is required": "Le champ description est obligatoire",
      "session field is required": "Le champ session est obligatoire",
      "register Fees field is required": "Le champ frais d'inscription est obligatoire",
      "price field is required": "Le champ prix est obligatoire",
      "hours field is required": "Le champ heures est obligatoire",
      "Actions": "Actions",
      "Action": "Action",
      "Close": "Fermer",
      "Role": "Rôle",
      ...
      "Block": "Blockage",
      "Archived": "Archivé",
      "Archived Students": "Étudiants archivés",
      "Register Certificat": "Attestation d'inscription",
      "Level Certificat": "Attestation de niveau",
      "Books": "Livres",
      "Title": "Titre",
      "Language": "Langue",
      ...
      "Color Price": "Prix couleur",
      "book Type field is required": "Le champ de type de livre est obligatoire",
      "language field is required": "Le champ de langue est obligatoire",
      "quantity field is required": "Le champ de quantité est obligatoire",
      "title field is required": "Le champ de titre est obligatoire",
      "level field is required": "Le champ de niveau est obligatoire",
      "actions field is required": "Le champ d'actions est obligatoire",
      "black And White Price field is required": "Le champ de prix noir et blanc est obligatoire",
      "color Price field is required": "Le champ de prix de la couleur est obligatoire",
      "Department Basic Info": "Informations de base du département",
      "Class": "Classe",
      "Brief": "Brève",
      "Floor": "Etage",
      "floor Name field is required": "Le champ de nom d'étage est obligatoire",
      "class Name field is required": "Le champ de nom de classe est obligatoire",
      "Brief field is required": "Un bref champ est obligatoire",
      "languages field is required": "Le champ de langues est obligatoire",
      "Option": "Option",
      "Groupe": "Groupe",
      "salles": "Salle",
      "option field is required": "Le champ d'option est obligatoire",
      "calindar field is required": "Le champ de calindar est obligatoire",
      "Teacher": "Enseignant",
      "Invice": "Inviter",
      ...
      "Samedi": "Samedi",
      "Dimanche": "Dimanche",
      "day field is required": "Le champ de jour est obligatoire",
      "Informations de bases": "Informations de base",
      "Modifier le profil": "Modifier le profil",
      "informations du compte": "Information sur le compte",
      "Prénom": "Prénom",
      "Jour": "Jour",
      "Soir": "Soir",
      "Weekend": "Week-end",
      ...
      "Homme": "Homme",
      "Femme": "Femme",
      "N° Telephone": "Téléphone",
      "Date de naissance": "Date de naissance",
      "is Account Activated": "Compte activé avec succés",
      "Oui": "Oui",
      "Non": "Non",
      "Teste ": "Testé",
      ...
      "Valider": "Valider",
      "Annuler": "Annuler",
      "firstname field is required": "Le champ est obligatoire",
      "lastname field is required": "Le champ est obligatoire",
      "email field is required": "Le champ est obligatoire",
      "email must be email": "Le champ est obligatoire",
      "password field is required": "Le champ est obligatoire",
      "confirm password field is required": "Le champ est obligatoire",
      "confirm password must be the same as password": "Le champ est obligatoire",
      "gender field is required": "Le champ est obligatoire",
      "phone field is required": "Le champ est obligatoire",
      "birthday field is required": "Le champ est obligatoire",
      "username field is required": "Le champ est obligatoire",
      "cin field is required": "Le champ est obligatoire",
      "type field is required": "Le champ est obligatoire",
      "Website": "Site Internet",
      "Note": "Note",
      "Read More": "En savoir plus",
      "Super Admin": "Super administrateur",
      "Admin": "Administrer",
      "role field is required": "Le champ est obligatoire",
      "Question": "Question",
      "Replay": "Rejouer",
      "Type": "Taper",
      "Export": "Exporter",
      ...
      "Message": "Message",
      "Send": "Envoyer",
      "message field is required": "Le champ est obligatoire",
      "students field is required": "Le champ est obligatoire",
      "Seen": "Vue",
      "Back": "Dos",
      "From": "Depuis",
      "To": "Pour",
      ...
      "Student Name field is required": "Le champ est obligatoire",
      "Payment Method field is required": "Le champ est obligatoire",
      "Amount field is required": "Le champ est obligatoire",
      "fees Type field is required": "Le champ est obligatoire",
      "book field is required": "Le champ est obligatoire",
      "Book": "Livre",
      "Cash": "Espèces",
      "Cheque": "Chéque",
      "Virement": "Virement",
      ...
      "host field is required": "Le champ est obligatoire",
      "port field is required": "Le champ est obligatoire",
      "security field is required": "Le champ est obligatoire",
      ...
      "there are no Blocks": "Il n'y a pas de blocs",
