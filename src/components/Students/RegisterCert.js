...
const RegisterCert = () => {
    ...
    const links = [ 
        ...
        { name: t("Register Certificat"), url: "#" }
    ]
    const tabs = []
                                ...
                                <div className="table-responsive push">
                                    <table className="table table-bordered table-hover text-nowrap">
                                        <tbody>
                                            <tr>
                                                <th>{t("Cin")}</th>
                                                <th className="text-center">{t("Option")}</th>
                                                <th className="text-right">{t("Session")}</th>
                                            </tr>
                                            <tr>
                                                <td>{singleStudent.cin}</td>
                                                <td className="text-center">{singleStudent.option}</td>
                                                <td className="text-right">{singleStudent.session}</td>
                                            </tr>
