									...
									<div className="card-body">
										...
										<ul className="list-group">
											<li className="list-group-item">
												<b>Gender </b>
												<div className="profile-desc-item pull-right">Female</div>
											</li>
											<li className="list-group-item">
												<b>Operation Done </b>
												<div className="profile-desc-item pull-right">30+</div>
											</li>
											<li className="list-group-item">
												<b>Degree </b>
												<div className="profile-desc-item pull-right">B.A., M.A., P.H.D.</div>
											</li>
											<li className="list-group-item">
												<b>Designation</b>
												<div className="profile-desc-item pull-right">Jr. Professor</div>
											</li>
                                            <li className="list-group-item">
                                                <div className="clearfix">
                                                    <div className="float-left"><strong>Java</strong></div>
                                            ...
                                            <li className="list-group-item">
                                                <div className="clearfix">
                                                    <div className="float-left"><strong>Angualar</strong></div>
                                            ...
                                            <li className="list-group-item">
                                                <div className="clearfix">
                                                    <div className="float-left"><strong>PhotoShop</strong></div>
