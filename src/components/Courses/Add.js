...
const Add = () => {
  ...
  const ProfessorsAddValidator = yup.object().shape({
    ...
    durtion: yup.string().required(t("durtion field is required")),
                  ...
                  <div className="col-sm-12">
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <div className="form-group row">
                          <label className="col-md-3 col-form-label">{t("Durtion")} </label>
                          <div className="col-md-9">

                            <DatePicker
                              selected={(values.durtion && new Date(values.durtion)) || null}
                              onChange={val => {
                                setFieldTouched("durtion")
                                setFieldValue("durtion", val);
                              }} className="form-control" placeholder={t("Enter your Durtion")} />

                            {touched.durtion && errors.durtion && <small className="text-danger">{errors.durtion}</small>}
                          </div>
                        </div> 
